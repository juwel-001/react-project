        ...
        <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-24 lg:px-6 ">
          ...
          <div className="max-w-screen-md mx-auto">
            ...
            >
              ...
              >
                <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                  <p classNameName="mb-2 text-gray-500 dark:text-gray-400">
                  ...
                  <ul classNameName="pl-5 text-gray-500 list-disc dark:text-gray-400">
                    <li>
                      <a
                        href="#"
                        classNameName="text-purple-600 dark:text-purple-500 hover:underline"
                      >
                        Landwind Pro
                      </a>
                    </li>
